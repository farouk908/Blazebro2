...
export default function HomePage({ onNavigateShop, products, onSelectProduct, getProductImage }: HomePageProps) {
            ...
            {featuredProducts.map((product, index) => (
              ...
              >
                <div className="aspect-square bg-zinc-100 mb-4 overflow-hidden">
                  <img src={getProductImage(product.image)} alt={product.name} className="w-full h-full object-cover group-hover:scale-105 transition-transform" />
                </div>
